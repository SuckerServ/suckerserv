...
IF(LUA5.2_INCLUDE_DIR)
  ...
  IF((NOT LUA5.2_VERSION VERSION_LESS 5.3 OR NOT LUA5.2_VERSION VERSION_GREATER 5.2) AND NOT LUA5.2_VERSION VERSION_EQUAL 5.2)
    # Wrong version
    MESSAGE(STATUS "Version of Lua header found is not 5.2. Found ${LUA5.2_VERSION}")
    SET(LUA5.2_INCLUDE_DIR FALSE)
  ENDIF((NOT LUA5.2_VERSION VERSION_LESS 5.3 OR NOT LUA5.2_VERSION VERSION_GREATER 5.2) AND NOT LUA5.2_VERSION VERSION_EQUAL 5.2)
